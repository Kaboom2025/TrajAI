...
- [ ] **Task: Implement Tool Call Assertions**
...
- [ ] **Task: Implement Output & Metadata Assertions**
...
- [ ] **Task: Conductor - User Manual Verification 'Pure Assertion Functions' (Protocol in workflow.md)**

## Phase 2: Trajectory Formatter & Rich Messages
- [ ] **Task: Implement TrajectoryFormatter**
...
- [ ] **Task: Conductor - User Manual Verification 'Trajectory Formatter' (Protocol in workflow.md)**
